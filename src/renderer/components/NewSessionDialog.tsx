...
import type { AgentConfig, AgentCategory } from '../../shared/types/agent';
...
export const NewSessionDialog: React.FC<NewSessionDialogProps> = ({
  ...
  const [type, setType] = useState<SessionType>('attached');
  ...
  const categoryOrder: AgentCategory[] = ['ai-agent', 'shell', 'custom'];
        ...
        <form onSubmit={handleSubmit}>
          <div className="dialog-content">
                        ...
                        <div className="agent-options">
                          {categoryAgents.map((agent) => (
                            ...
                            >
                              ...
                              {!agent.available && (
                                <span className="agent-badge unavailable">
                                  Not installed
                                </span>
                              )}
                            </label>
            ...
            <div className="form-group">
              ...
              >
                <span className={`toggle-icon ${showAdvanced ? 'open' : ''}`}>
                  ▶
                </span>
                Advanced Options
              </button>
                    ...
                    <div className="radio-group">
                      <label className="radio-label">
                        <input
                          ...
                          name="type"
                          value="attached"
                          checked={type === 'attached'}
                          onChange={() => setType('attached')}
                        />
                        <span>Attached</span>
                      ...
                      <label className="radio-label">
                        <input
                          ...
                          name="type"
                          value="isolated"
                          checked={type === 'isolated'}
                          onChange={() => setType('isolated')}
                          disabled={!isGitRepo}
                        />
                        <span>Isolated (Worktree)</span>
                        <span className="radio-description">
                          Create a separate worktree for branch isolation
